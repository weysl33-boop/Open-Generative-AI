...
export const ADMIN_NAV_GROUPS = [
  ...
  },
  {
    ...
    icon: 'Plug2',
    items: [
      { id: 'login-methods', href: '/admin/login', label: '登录方式与连通性', permission: 'providers.read' },
    ],
  },
  {
    id: 'integrations',
 ...
 * 社交/短信合并进 /admin/login；邮箱 SMTP 独立成 /admin/email 单页设置。
 */
export const ADMIN_LEGACY_REDIRECTS = {
  '/admin/providers': '/admin/models/providers',
  '/admin/providers/models': '/admin/models',
  '/admin/providers/social': '/admin/login?category=social',
  '/admin/providers/sms': '/admin/login?category=sms',
